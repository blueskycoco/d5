/***********************************************************************
* $Id:: lpc32xx_rtc.h 627 2008-04-18 19:39:54Z wellsk                 $
*
...
typedef struct {
	volatile UNS_32 ucount;   /* RTC up counter register */
	volatile UNS_32 dcount;   /* RTC down counter register */
	volatile UNS_32 match0;   /* RTC match 0 register */
	volatile UNS_32 match1;   /* RTC match 1 register */
	volatile UNS_32 ctrl;     /* RTC control register */
	volatile UNS_32 intstat;  /* RTC interrupt status register */
	volatile UNS_32 key;      /* RTC ONSW (alarm) enable register */
	volatile UNS_32 reserved [25];
	volatile UNS_32 sram [32]; /* RTC power backed static RAM */
} RTC_REGS_T;
