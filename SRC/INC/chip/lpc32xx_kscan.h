/***********************************************************************
* $Id:: lpc32xx_kscan.h 627 2008-04-18 19:39:54Z wellsk               $
*
...
typedef struct {
	volatile UNS_32 ks_deb;     /* Keypad debounce duration register */
	volatile UNS_32 ks_state_cond; /* Keypad current state register */
	volatile UNS_32 ks_irq;     /* Keypad interrupt register */
	volatile UNS_32 ks_scan_ctl; /* Keypad scan delay control reg */
	volatile UNS_32 ks_fast_tst; /* Keypad scan clock control reg */
	volatile UNS_32 ks_matrix_dim; /* Keypad matrix dim sel reg */
	volatile UNS_32 reserved [10];
	volatile UNS_32 ks_data [8]; /* Keypad data 0 to 7 registers */
} KSCAN_REGS_T;
