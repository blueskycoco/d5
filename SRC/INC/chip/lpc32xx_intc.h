/***********************************************************************
* $Id:: lpc32xx_intc.h 627 2008-04-18 19:39:54Z wellsk                $
*
...
typedef struct 
{
    volatile UNS_32 er;  /* Enable Register */
    volatile UNS_32 rsr; /* Raw Status Register */
    volatile UNS_32 sr;  /* Status Register */
    volatile UNS_32 apr; /* Activation Polarity select Register */
    volatile UNS_32 atr; /* Activation Type select Register */
    volatile UNS_32 itr; /* Interrupt Type select Register */
} INTC_REGS_T;
...
#define MIC_APR_DEFAULT		0x3FF0E7F8
