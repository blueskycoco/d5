/***********************************************************************
* $Id:: lpc32xx_wdt.h 742 2008-05-13 15:34:23Z wellsk                  $
*
...
typedef struct {
    ...
    volatile UNS_32 wdtim_emr;      /* WDT external match control register */
...
#define WDT_PAUSE_EN            _BIT(2) /* Timer Counter is stopped in debug mode */
