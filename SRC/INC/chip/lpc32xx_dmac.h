/***********************************************************************
* $Id:: lpc32xx_dmac.h 627 2008-04-18 19:39:54Z wellsk                $
*
...
typedef struct {
    volatile UNS_32 src_addr;           /* Source address reg */
    volatile UNS_32 dest_addr;          /* Destination address reg */
    volatile UNS_32 lli;                /* Linked list item reg */
    volatile UNS_32 control;            /* Channel control reg */
    volatile UNS_32 config_ch;          /* Channel config reg */
    volatile UNS_32 reserved [3];
} DMAC_CHAN_T;

/* DMA controller register structures */ 
typedef struct {
    volatile UNS_32 int_stat;           /* Interrupt status reg */
    volatile UNS_32 int_tc_stat;        /* INT terminal count req sts */
    volatile UNS_32 int_tc_clear;       /* INT terminal count clear */
    volatile UNS_32 int_err_stat;       /* Interrupt error sts reg */
    volatile UNS_32 int_err_clear;      /* Interrupt error clear reg */
    volatile UNS_32 raw_tc_stat;        /* Raw terminal count reg */
    volatile UNS_32 raw_err_stat;       /* Raw error status reg */
    volatile UNS_32 chan_enable;        /* Enabled channel reg */
    volatile UNS_32 sw_burst_req;       /* SW burst req reg */
    volatile UNS_32 sw_single_req;      /* SW single req reg */
    volatile UNS_32 sw_last_burst_req;  /* SW last burst req reg */
    volatile UNS_32 sw_last_single_req; /* SW last single req reg */
    volatile UNS_32 config;             /* Config register */
    volatile UNS_32 sync;               /* Synchronization register */
...
typedef struct 
{
	volatile UNS_32 dma_src;     /* Source for data transfer */
	volatile UNS_32 dma_dest;    /* Destination for data transfer */
	volatile UNS_32 next_lli;    /* Next linked list pointer or NULL */
	volatile UNS_32 next_ctrl;   /* DMA control word for list entry */
} DMAC_LL_T;
